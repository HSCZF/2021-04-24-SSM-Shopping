        ...
        <form id="deliverLogin" class="form-horizontal">
            <div class="login-center clearfix form-group">
                ...
                <div class="login-center-input">
                    <input type="text" name="userName" id="deliverName" value="" placeholder="请输入您的账号"
            ...
            <div class="login-center clearfix form-group">
                ...
                <div class="login-center-input">
                    <input type="password" name="passWord" id="deliverPassWord" value="" placeholder="请输入您的密码"
                           onfocus="this.placeholder=''" onblur="this.placeholder='请输入您的密码'">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary col-sm-4" id="register_btn">返回首页</button>
        ...
        if(flag){
            $.ajax({
                ...
                success: function (result){
                    if(result.code == 200){
                        // 跳转到商城首页
                        window.parent.location = "${APP_PATH}/product/searchAllProducts";
                    }else {
                        toastr.options = {
