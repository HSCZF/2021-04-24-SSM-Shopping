...
public interface CommentService {
     ...
     * @return
     */
    public Boolean updateDeliverOrderStatusByDeliverIdAndOrderId(@Param("deliverId") Integer deliverId,
                                                             @Param("orderId") Integer orderId,
                                                             @Param("cStatus") Integer deliverStatus);
     ...
     * @return
     */
    public Boolean updateFinishedByDeliverAndOrderId(@Param("deliverId") Integer deliverId,
                                                     @Param("orderId") Integer orderId,
     ...
     * @return
     */
    public Boolean updateComment(@Param("comment") String comment,
                             @Param("orderId") Integer orderId);
     ...
     * @return
     */
    public Boolean updateAddress(@Param("userAddress") String userAddress,
                             @Param("id") Integer id);
